...
function Loader() {
  ...
  return (
    <div className={`fixed top-0 left-0 w-full h-full z-[200] bg-[#0b0c15] flex flex-col items-center justify-center transition-opacity duration-1000 ${progress === 100 ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
